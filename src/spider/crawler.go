...
type Crawler struct {
	...
	subSet  *utils.StringFilter
	awsSet  *utils.StringFilter
	jsSet   *utils.StringFilter
	urlSet  *utils.StringFilter
	formSet *utils.StringFilter
...
func NewCrawler(site *url.URL, cmd *cobra.Command) *Crawler {
	...
	return &Crawler{
		...
		domain:              domain,
		Output:              output,
		urlSet:              utils.NewStringFilter(),
		subSet:              utils.NewStringFilter(),
		jsSet:               utils.NewStringFilter(),
		formSet:             utils.NewStringFilter(),
		awsSet:              utils.NewStringFilter(),
...
func (crawler *Crawler) Start(linkfinder bool) {
	...
	// Find Upload Form
	uploadFormSet := utils.NewStringFilter()
